...
function AvatarDropdown() {
    return (
        <Menu as="div" className="relative inline text-left">
            ...
            >
                <Menu.Items className="border-1 absolute right-0 z-50 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md border border-slate-600 bg-slate-900 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
